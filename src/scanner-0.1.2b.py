...
#        text="<for statement='"+self.tagbodytemp+"'>"
    ...
    def labeling(self):
        while self.lastchar:
            #print self.lastchar
            if self.lastchar=='/' and self.inquota==False:
                #potentially comment
                self.read()
                if self.lastchar=='/':
                    #line comment
                ...
                if self.lcomment==True:
                    ...
                    self.read()
            elif self.lastchar=='*' and self.inquota==False:
...
#                                                    self.pragma=True
            ...
            elif (self.lastchar=='f' and self.lcomment==False and self.bcomment==False and self.inquota==False):
...
J=scanner("vectorAdd4.c","__inter.xml")
J.labeling()
