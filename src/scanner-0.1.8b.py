...
class scanner(object):
    def __init__(self, fname=None, foname=None):
        ...
        self.fohandle.write('<scanner version=\'0.1.8b\'>\n') #initial the output XML file
...
#        text="<for statement='"+self.tagbodytemp+"'>"
    ...
    def labeling(self):
        while self.lastchar:
            ...
            elif (self.lastchar=='f' and self.lcomment==False and self.bcomment==False and len(self.pragmastack)>0 and self.inquota==False):
