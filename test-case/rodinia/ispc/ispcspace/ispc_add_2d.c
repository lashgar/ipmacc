...
extern "C" void __generated_kernel_launch_0(float  a[],float  c[],float  b[],unsigned int __ispc_n_threads,unsigned int  SIZEX,unsigned int  SIZEY);
...

    {
        ...
        for(k = 0; k < iter; k++)
        {
            ...
            /* kernel call statement*/
            {
                ...
                __generated_kernel_launch_0(a,c,b,__ispc_n_threads,SIZEX,SIZEY);
            }
            /* kernel call statement*/
