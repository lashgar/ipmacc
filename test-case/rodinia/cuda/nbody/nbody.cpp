...
bool compare_runcudaonly=false;
bool compare_runopenacconly=false;
...
main(int argc, char **argv)
{
    ...
    compare_runcudaonly  = (checkCmdLineFlag(argc, (const char **) argv, "cuda") != 0);
    compare_runopenacconly  = (checkCmdLineFlag(argc, (const char **) argv, "openacc") != 0);
    if(compareToCPU && !(compare_runcudaonly || compare_runopenacconly)){
        printf("Usage: -compare -cuda or -compare -openacc\n");
        exit(-1);
    }
