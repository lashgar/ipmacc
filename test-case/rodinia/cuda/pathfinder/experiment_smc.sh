...
function run_benchmarks_nvprof()
{
 ...
 #do
  ...
  if [ "$DEBUG" == "1" ] ; then
   ...
   nvprof --print-gpu-trace ./pathfinder $args &> ../../$i.$3.txt
  else
   kernel=
   memory=
   launch=
   for (( j=0; j<$iter; j++)); do
    nvprof --print-gpu-trace ./pathfinder $args &> .log.txt
    #bash $path/$i/runnvprof &> .log.txt
    nvprof --print-api-summary ./pathfinder $args &> .log_api.txt
...
if [ "$RUN" == "1" ]; then
 ...
 run_benchmarks_nvprof $ROOT/cuda/ $ITER cuda100K_100 pathfinder 100000 1000 100
 run_benchmarks_nvprof $ROOT/cuda/ $ITER cuda100K_5   pathfinder 100000 1000 5
 run_benchmarks_nvprof $ROOT/cuda/ $ITER cuda100K_4   pathfinder 100000 1000 4
 run_benchmarks_nvprof $ROOT/cuda/ $ITER cuda100K_3   pathfinder 100000 1000 3
 run_benchmarks_nvprof $ROOT/cuda/ $ITER cuda100K_2   pathfinder 100000 1000 2
 run_benchmarks_nvprof $ROOT/cuda/ $ITER cuda50K_100  pathfinder  50000 1000 100
 run_benchmarks_nvprof $ROOT/cuda/ $ITER cuda50K_5    pathfinder  50000 1000 5
 run_benchmarks_nvprof $ROOT/cuda/ $ITER cuda50K_4    pathfinder  50000 1000 4
 run_benchmarks_nvprof $ROOT/cuda/ $ITER cuda50K_3    pathfinder  50000 1000 3
 run_benchmarks_nvprof $ROOT/cuda/ $ITER cuda50K_2    pathfinder  50000 1000 2
fi
